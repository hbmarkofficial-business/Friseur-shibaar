  ...
  return (
    <>
      <Helmet>
        ...
        <title>Friseursalon Berlin | Friseur Shibaar</title>
        <meta
          name="description"
          content="Besuche unseren Premium Friseursalon Friseur Shibaar in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Friseur Shibaar | Premium Friseursalon Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Friseur Shibaar | Premium Friseursalon Berlin" />
        <meta
